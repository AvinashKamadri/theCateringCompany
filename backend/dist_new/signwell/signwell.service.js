...
var SignWellService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SignWellService = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const axios_1 = require("axios");
let SignWellService = SignWellService_1 = class SignWellService {
    constructor(configService) {
        this.configService = configService;
        this.logger = new common_1.Logger(SignWellService_1.name);
        ...
        const apiUrl = this.configService.get('SIGNWELL_API_URL') ||
        ...
        this.logger.log(`SignWell service initialized (enabled: ${this.enabled}, test mode: ${this.testMode})`);
    }
    async sendDocumentForSignature(options) {
        ...
        try {
            ...
            this.logger.log(`Document sent successfully. ID: ${response.data.id}`);
            return response.data;
        }
        catch (error) {
            this.logger.error('Failed to send document to SignWell', error.response?.data || error.message);
            throw new Error(`SignWell API error: ${error.response?.data?.message || error.message}`);
        }
    }
...
exports.SignWellService = SignWellService = SignWellService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], SignWellService);
//# sourceMappingURL=signwell.service.js.map