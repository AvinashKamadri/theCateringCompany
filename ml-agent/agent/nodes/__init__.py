...
from agent.nodes.basic_info import (
    ...
    collect_fiance_name_node,
    collect_birthday_person_node,
    collect_company_name_node,
    collect_venue_node,
...
NODE_MAP = {
    ...
    "collect_fiance_name": collect_fiance_name_node,
    "collect_birthday_person": collect_birthday_person_node,
